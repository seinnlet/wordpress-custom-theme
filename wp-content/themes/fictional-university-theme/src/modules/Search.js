...
class Search {
  ...
  typingLogic() {
    if (this.searchField.val() != this.previousValue) {   // for arrow keys key down
      clearTimeout(this.typingTimer);

      if (this.searchField.val()) {   // for spinning only when there is a value in input
  ...
  getResults() {
    ...
    // only page and pages with when and then
    // $.when(
